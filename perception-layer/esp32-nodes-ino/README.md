# 📡 Nodos IoT ESP32 para Monitoreo y Detección de Ataques de Desautenticación en Redes Wi‑Fi

## 🗂️ Índice

- [📡 Nodos IoT ESP32 para Monitoreo y Detección de Ataques de Desautenticación en Redes Wi‑Fi](#-nodos-iot-esp32-para-monitoreo-y-detección-de-ataques-de-desautenticación-en-redes-wifi)
  - [🗂️ Índice](#️-índice)
